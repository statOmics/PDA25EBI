...
- Léopold Guyot, Loïc Guille and the Laurent Gatto lab for the development of [QFeaturesGUI](https://github.com/UCLouvain-CBIO/QFeaturesGUI), which we forked to add some additional features for this course. 
